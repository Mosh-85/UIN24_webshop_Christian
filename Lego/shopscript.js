...
<button onclick="addToCart(${product.prodid})">Legg i Handlevogn</button>
</article>`)
...
function addToCart(productid) {
    //console.log("Legger til produkt med id " + productid + " i handlekurven")
...
function removeFromCart(index) {
    console.log("Fjerner produkt med index " + index + " fra handlekurven")
